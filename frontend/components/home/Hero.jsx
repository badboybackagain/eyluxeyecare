      ...
      <div className="relative mx-auto max-w-7xl px-6 w-full pt-32 pb-20">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            >
              A Boutique Vision Experience in Hadapsar - Advanced Eye Care, Curated Designer Eyewear, Precision Progressive Lenses, Children's Vision Solutions, and the Future of Smart Eyewear with Meta AI Glasses.
            </motion.p>
